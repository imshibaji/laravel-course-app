                            ...
                            <div className="col-md-3 order-2 order-md-1">
                                <div className="row">
                                    <div className="col-6 col-md-12 mt-3">
                                        <img src={data.image ? URL.createObjectURL(data.image) : 'https://shibajidebnath.com/wp-content/uploads/2024/04/Web-design.webp'} alt="Course Image" className="img-fluid rounded" />
                                        <div className="mt-3">
                                    ...
                                    <div className="col-6 col-md-12 mt-3">
                                        <img src={data.certificate ? URL.createObjectURL(data.certificate) : 'https://shibajidebnath.com/wp-content/uploads/2024/04/Web-design.webp'} alt="Course Certificate" className="img-fluid rounded" />
                                        <div className="mt-3">
