...
export default function Page() {
    ...
    return (
        <FrontLayout title={settings.privacy_policy_title || "Page Title"}>
            <section className="py-3">
                <div className="container">
                    <div className="card">
                        <div className="card-body">
                            <h3 className="text-start mb-0">{settings.privacy_policy_title || "Page Title"}</h3>
                            <p className="text-start mb-4">{settings.privacy_policy_description || "Page Description"}</p>
                            <hr className="my-4" />
                            <AppMarkdown content={settings.privacy_policy_content} />
                        </div>
                    </div>
                </div>
            </section>
